...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        if self.defaultSaveDir is None and saveDir is not None and os.path.exists(saveDir):
            ...
            self.statusBar().showMessage('%s started. Annotations will be saved to %s' %
        ...
        try:
            if self.usingPascalVocFormat is True:
                ...
                self.labelFile.save(annotationFilePath, shapes, self.filePath, self.imageData,
                                    self.lineColor.getRgb(), self.fillColor.getRgb())
            print('Image:{0} -> Annotations:{1}'.format(self.filePath, annotationFilePath))
            return True
    ...
    def changeSavedirDialog(self, _value=False):
        ...
        self.statusBar().showMessage('%s . Annotations will be saved to %s' %
    ...
    def openAnnotationDialog(self, _value=False):
        ...
        if self.usingPascalVocFormat:
            filters = "Open Annotations XML file (%s)" % ' '.join(['*.xml'])
